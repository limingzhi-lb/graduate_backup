...
| field                      | type        | index | isnull |
| -------------------------- | ----------- | ----- | ------ |
| rm_id                      | integer     | yes   | no     |
| 名称 name                  | varchar(12) | yes   | no     |
...
| field                                        | type     | index | isnull          |
| -------------------------------------------- | -------- | ----- | --------------- |
| ord_form_id                                  | integer  | yes   | no              |
| 供应商id ven_id                              | integer  | yes   | no              |
| 创建日期 created                             | datetime | no    | no              |
| 调入仓库（若退货可为空）                     | integer  | yes   | no (default:-1) |
| 交货日期 delivery                            | datetime | no    | no              |
| 类型（购货/退货）type                        | boolean  | yes   | no              |
...
| 购货单 ord_form_id | integer | yes   | no     |
...
| 产品名称 good_id                     | integer | yes   | no         |
| 数量 number                          | integer | no    | no         |
...
| field            | type     | index | isnull |
| ---------------- | -------- | ----- | ------ |
| pro_id           | integer  | yes   | no     |
| 名称 name        | char(8)  | yes   | no     |
| 所需原材料 rm_id | json     | no    | yes    |
| 所需半成品 hp_id | json     | no    | yes    |
...
| field            | type    | index | isnull |
| ---------------- | ------- | ----- | ------ |
| hd_id            | integer | yes   | no     |
| 名称 name        | char(8) | yes   | no     |
| 所需原材料 rm_id | json    | no    | no     |
|                  |         |       |        |
|                  |         |       |        |
|                  |         |       |        |
...
| field       | type        | index | isnull |
| ----------- | ----------- | ----- | ------ |
| sfp_id      | integer     | yes   | no     |
| 商品id p_id | integer     | yes   | no     |
| 商品名 name | varchar(12) | yes   | no     |
| 数量 num    | integer     | no    | no     |
